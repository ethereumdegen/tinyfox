   ...
   async createCollectionUniqueIndexes()
    {
      ...
      await this.createDualIndexOnCollection('event_list', 'transactionHash', 'logIndex')

      await this.createIndexOnCollection('event_list', 'hasAffectedLedger')//speed up retrival
        

      await this.createDualIndexOnCollection('erc20_balances', 'accountAddress', 'contractAddress')
      await this.createDualIndexOnCollection('erc20_approval', 'accountAddress', 'contractAddress')
      await this.createDualIndexOnCollection('erc721_balances', 'accountAddress', 'contractAddress')
